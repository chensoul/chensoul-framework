 ...
 * {@link AuthenticationUtil} to check roles in the same
...
public class VaadinRolePrefixHolder implements Serializable {
     ...
     *
     * @param request Vaadin request used to find active role prefix.
     */
    public void resetRolePrefix(HttpServletRequest request) {
     ...
     * Method doesn't do anything if role prefix is not found.
     *
     * @param defaultSecurityFilterChain Default security filter chain used to find active role prefix.
     * @throws NullPointerException If <code>defaultSecurityFilterChain</code> is null.
     */
