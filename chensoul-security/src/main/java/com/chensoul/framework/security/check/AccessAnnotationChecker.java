 ...
 * the License.
 */
package com.chensoul.framework.security.check;
...
public class AccessAnnotationChecker implements Serializable {
    ...
    public boolean hasAccess(Method method) {
        HttpServletRequest request = Optional.of((ServletRequestAttributes) RequestContextHolder.getRequestAttributes())
     ...
     * <li>{@code @DenyAll}
     * </ul>
     * @throws NullPointerException if the input {@code cls} is null
     */
