 ...
 * the License.
 */
package com.chensoul.framework.security.stateless;

import com.chensoul.framework.security.VaadinSavedRequestAwareAuthenticationSuccessHandler;
...
public final class VaadinStatelessSecurityConfigurer<H extends HttpSecurityBuilder<H>>
     ...
     *
     * @param http the http security builder to store the shared object.
     ...
     *
     * @param issuer string identifier or URL of the issuer
     * @return the {@link VaadinStatelessSecurityConfigurer} for further
     * customization
     */
     ...
     * Specifies using a secret key for signing and verification.
     *
     * @param customizer the {@link Customizer} to provide configuration for the
