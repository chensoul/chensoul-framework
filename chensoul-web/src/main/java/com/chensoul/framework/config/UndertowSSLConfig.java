...
public class UndertowSSLConfig {
    ...
    private final Logger log = LoggerFactory.getLogger(UndertowSSLConfig.class);

    public UndertowSSLConfig(UndertowServletWebServerFactory undertowServletWebServerFactory) {
