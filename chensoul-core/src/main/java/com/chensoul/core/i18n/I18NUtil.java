...
package com.chensoul.core.i18n;

import static com.chensoul.core.i18n.DefaultI18NProvider.BUNDLE_FILENAME;
import static com.chensoul.core.i18n.DefaultI18NProvider.BUNDLE_FOLDER;
import java.io.File;
...
public final class I18NUtil {
    ...
    public static boolean containsDefaultTranslation(ClassLoader classLoader) {
        URL resource = classLoader.getResource(BUNDLE_FOLDER
                + "/" + BUNDLE_FILENAME
                + PROPERTIES_SUFFIX);
        if (resource==null) {
            return false;
