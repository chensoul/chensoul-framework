...
public class DefaultI18NProvider implements I18NProvider {
    ...
    public static final String BUNDLE_FOLDER = "i18n";
    public static final String BUNDLE_FILENAME = "properties";
     ...
     * translations for.
     *
     * @param providedLocales List of locales. The first locale should be the default
     *                        locale.
     */
     ...
     * @param providedLocales List of locales. The first locale should be the default
     *                        locale.
     * @param classLoader     ClassLoader to use for loading translation bundles.
     */
    public DefaultI18NProvider(List<Locale> providedLocales,
